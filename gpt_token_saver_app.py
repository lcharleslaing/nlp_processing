...
# Dummy class to handle sys.stderr.flush and sys.stderr.write
...
# Redirect sys.stderr to a dummy object
...
try:
    ...
    def save_processed_text(text, original_file_path):
        ...
        if save_directory:
            ...
            try:
                ...
                messagebox.showinfo(
                    "Info", "Processed text saved successfully")
            except Exception as e:
                messagebox.showerror(
    ...
    title_label = ttk.Label(
        title_frame, text="GPT Token Saver", font=title_font)
